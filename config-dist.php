...
$CFG->dbhost    = 'vh300.timeweb.ru';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'ct39665_moodle';     // database name, eg moodle
$CFG->dbuser    = 'ct39665';   // your database username
